...
export const PROTEIN = {
  ...
  'pollo':         { name: 'Pollo',             ration: { grams: 150 },                          per100: 1.00,  kc: 190, cookFat: 235, preps: [],                                             combos: 'shared',        meals: ['comida','cena'] },
  'bacalao':       { name: 'Bacalao',           ration: { grams: 150 },                          per100: 1.06,  kc: 90,  cookFat: 235, preps: [],                                             combos: 'shared',        meals: ['comida','cena'] },
  'huevos':        { name: 'Huevos',            ration: { units: 3 }, perUnit: 0.488, kcu: 72,                  cookFat: 235, preps: [],                                             combos: 'shared',        meals: ['comida','cena'] },
  'lamb':          { name: 'Lamb',              ration: { grams: 120 },                          per100: 1.982, kc: 230, cookFat: 235, preps: [],                                             combos: 'shared',        meals: ['comida'] },
  'lomo':          { name: 'Lomo',              ration: { grams: 150 },                          per100: 0.66,  kc: 170, cookFat: 235, preps: [],                                             combos: 'lomo',          meals: ['comida'] },
  ...
  'calamares':     { name: 'Calamares',          ration: { grams: 150 },                          per100: 1.760, kc: 92,  cookFat: 235, preps: [],                                             combos: 'shared',        meals: ['comida','cena'] },
  ...
  'pollock':       { name: 'Pollock',            ration: { grams: 150 },                          per100: 1.00,  kc: 82,  cookFat: 235, preps: [],                                             combos: 'shared',        meals: ['cena'] },
  'langosta':      { name: 'Langosta (picada)',  ration: { grams: 150 },                          per100: 1.99,  kc: 90,  cookFat: 235, preps: [],                                             combos: 'shared',        meals: ['cena'] },
  'ostras':        { name: 'Ostras (Malpeques)', ration: { units: 6 }, perUnit: 0.83, kcu: 50,                    cookFat: 120, preps: [],                                             combos: 'shared',        meals: ['cena'] },
}
