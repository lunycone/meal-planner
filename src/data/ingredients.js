...
export const ING = {
  ...
  mejillones:       { name: 'Mejillones (Canadian Cove Organic)', cat: 'carne', per100: 0.771, kc: 172, pack: '907 g · $6.99', per: '150g → $1.16 · 258 kcal' },
  'pulpo-congelado': { name: 'Pulpo congelado (Ferma)', cat: 'carne', per100: 1.73,  kc: 82,  prot: 25, pack: '750 g · $12.99',    per: '150g cocido → $2.60 · 37g prot' },
  salchichas:        { name: 'Salchichas (English Bangers)', cat: 'carne', per100: 0.599, kc: 300, prot: 14, fat: 24, pack: '~0.91 kg · $5.45 est (CA$5.99/kg)', per: '150g → $0.90 · 450 kcal' },
  bacon:             { name: 'Bacon (Lifesmart Uncured)',    cat: 'carne', per100: 2.131, kc: 540, prot: 37, fat: 42, pack: '375 g · $7.99',       per: '40g → $0.85 · 216 kcal' },
  'cerdo-picado':   { name: 'Cerdo picado (Heritage, Linton)', cat: 'carne', per100: 1.899, kc: 260, pack: 'kg · $18.99', per: '100g → $1.90 · 260 kcal' },
  // CARNES Y PESCADO — ordenados por precio ascendente
  'ham-hock':               { name: 'Jarrete ahumado (Ham Hock)',                  cat: 'carne', per100: 1.80,  kc: 200, prot: 20, fat: 12, pack: '~700g ud · $4.50 (→ ~250g carne útil)', per: '40g → $0.72 · 80 kcal' },
  'costillas-cerdo':        { name: 'Costillas de cerdo',                          cat: 'carne', per100: 0.60,  kc: 250, prot: 17, fat: 20, pack: 'kg · $6.00',              per: '100g → $0.60 · 250 kcal' },
  'lomo-cerdo':             { name: 'Cerdo · Lomo (Conestoga, Foodland)',          cat: 'carne', per100: 0.65,  kc: 143, prot: 22, fat: 5,  pack: '~$6.50/kg est.',         per: '150g → $0.98 · 215 kcal', est: true },
  'solomillo-cerdo':        { name: 'Cerdo · Solomillo (Foodland)',                cat: 'carne', per100: 0.88,  kc: 143, prot: 22, fat: 3,  pack: '$8.80/kg',               per: '150g → $1.32 · 215 kcal' },
  'rib-rack-cerdo':         { name: 'Cerdo · Rib Rack Roast / Lomo (Conestoga)',   cat: 'carne', per100: 0.88,  kc: 220, prot: 19, fat: 15, pack: '$8.80/kg',               per: '150g → $1.32 · 330 kcal' },
  ...
  'turkey-drumstick':       { name: 'Pavo · Muslito (Turkey Drumstick, genérico)', cat: 'carne', per100: 0.88,  kc: 159, prot: 20, fat: 8,  pack: '$8.80/kg',               per: '200g → $1.76 · 318 kcal' },
  'pollo-pierna':           { name: 'Pollo · Pierna entera (Beretta)',             cat: 'carne', per100: 1.10,  kc: 172, prot: 18, fat: 11, pack: '$11.00/kg',              per: '250g → $2.75 · 430 kcal' },
  'pollo-muslito':          { name: 'Pollo · Muslito / Jamoncito (Beretta)',       cat: 'carne', per100: 1.10,  kc: 172, prot: 18, fat: 11, pack: '$11.00/kg',              per: '120g → $1.32 · 206 kcal' },
  'pollo-muslo-air':        { name: 'Pollo · Contramuslo c/hueso (Foodland AC)',   cat: 'carne', per100: 1.387, kc: 177, prot: 18, fat: 12, pack: '$13.87/kg',             per: '150g → $2.08 · 266 kcal' },
  'pollo-muslo-beretta':    { name: 'Pollo · Contramuslo c/hueso (Beretta)',       cat: 'carne', per100: 1.751, kc: 177, prot: 18, fat: 12, pack: '$17.51/kg',             per: '150g → $2.63 · 266 kcal' },
  'pollo-muslito-farmboy':  { name: 'Pollo · Muslito orgánico (Farm Boy)',         cat: 'carne', per100: 1.819, kc: 172, prot: 18, fat: 11, pack: '$18.19/kg',             per: '120g → $2.18 · 206 kcal' },
  'pollo-muslo-farmboy':    { name: 'Pollo · Contramuslo orgánico (Farm Boy)',     cat: 'carne', per100: 1.939, kc: 177, prot: 18, fat: 12, pack: '$19.39/kg',             per: '150g → $2.91 · 266 kcal' },
  'pollo-muslo-deshuesado': { name: 'Pollo · Contramuslo deshuesado (Foodland)',   cat: 'carne', per100: 2.379, kc: 180, prot: 19, fat: 12, pack: '$23.79/kg',             per: '120g → $2.85 · 216 kcal' },
  'pollo-pechuga':          { name: 'Pollo · Pechuga deshuesada (Beretta)',        cat: 'carne', per100: 2.563, kc: 120, prot: 22, fat: 2.6, pack: '$25.63/kg',            per: '120g → $3.08 · 144 kcal' },
