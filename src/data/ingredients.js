...
export const ING = {
  ...
  'cerdo-picado':   { name: 'Cerdo picado (Heritage, Linton)', cat: 'carne', per100: 1.899, kc: 260, prot: 17, fat: 18, pack: 'kg · $18.99', per: '100g → $1.90 · 260 kcal · 17g prot' },
  ...
  cebolla:          { name: 'Cebolla amarilla', cat: 'fresco', per100: 0.185, kc: 40, prot: 1.1, fat: 0.1, fib: 1.7, pack: '10 lb · $8.39', per: '150g (1 ud) → $0.28 · 60 kcal' },
  zanahoria:        { name: 'Zanahoria (No Name Naturally Imperfect)', cat: 'fresco', per100: 0.220, kc: 41, prot: 0.9, fat: 0.2, fib: 2.8, pack: '2270g · $5.00 (No Frills)', per: '150g → $0.33 · 62 kcal' },
  ...
  manzana:          { name: 'Manzana',           cat: 'fresco', perUnit: 1.20, kcu: 95, protu: 0.5, fatu: 0.3, fibu: 4, pack: 'ud · $1.20', per: '1 ud → $1.20 · 95 kcal' },
