...
export const ING = {
  ...
  'ham-hock':               { name: 'Jarrete ahumado (Ham Hock)',                  cat: 'otro', per100: 1.80,  kc: 200, prot: 20, fat: 12, pack: '~700g ud · $4.50 (→ ~250g carne útil)', per: '40g → $0.72 · 80 kcal' },
  'costillas-cerdo':        { name: 'Costillas de cerdo',                          cat: 'otro', per100: 0.60,  kc: 250, prot: 17, fat: 20, pack: 'kg · $6.00',              per: '100g → $0.60 · 250 kcal' },
  'lomo-cerdo':             { name: 'Lomo de cerdo',                               cat: 'otro', per100: 0.65,  kc: 143, prot: 22, fat: 5,  pack: '~$6.50/kg est.',         per: '150g → $0.98 · 215 kcal', est: true },
  'carne-picada':           { name: 'Carne picada de res (premium)',               cat: 'otro', per100: 2.423, kc: 254, prot: 17, fat: 20, pack: '$10.99/lb ($24.23/kg)',  per: '150g → $3.63 · 381 kcal' },
  'pollo-pierna-generic':   { name: 'Pollo · Pierna (genérico)',                   cat: 'otro', per100: 0.88,  kc: 172, prot: 18, fat: 11, pack: '$8.80/kg',               per: '250g → $2.20 · 430 kcal' },
  'turkey-drumstick':       { name: 'Pavo · Muslito (Turkey Drumstick, genérico)', cat: 'otro', per100: 0.88,  kc: 159, prot: 20, fat: 8,  pack: '$8.80/kg',               per: '200g → $1.76 · 318 kcal' },
  'pollo-pierna':           { name: 'Pollo · Pierna entera (Beretta)',             cat: 'otro', per100: 1.10,  kc: 172, prot: 18, fat: 11, pack: '$11.00/kg',              per: '250g → $2.75 · 430 kcal' },
  'pollo-muslito':          { name: 'Pollo · Muslito / Jamoncito (Beretta)',       cat: 'otro', per100: 1.10,  kc: 172, prot: 18, fat: 11, pack: '$11.00/kg',              per: '120g → $1.32 · 206 kcal' },
  'pollo-muslo-air':        { name: 'Pollo · Contramuslo c/hueso (Foodland AC)',   cat: 'otro', per100: 1.387, kc: 177, prot: 18, fat: 12, pack: '$13.87/kg',             per: '150g → $2.08 · 266 kcal' },
  'pollo-muslo-beretta':    { name: 'Pollo · Contramuslo c/hueso (Beretta)',       cat: 'otro', per100: 1.751, kc: 177, prot: 18, fat: 12, pack: '$17.51/kg',             per: '150g → $2.63 · 266 kcal' },
  'pollo-muslito-farmboy':  { name: 'Pollo · Muslito orgánico (Farm Boy)',         cat: 'otro', per100: 1.819, kc: 172, prot: 18, fat: 11, pack: '$18.19/kg',             per: '120g → $2.18 · 206 kcal' },
  'pollo-muslo-farmboy':    { name: 'Pollo · Contramuslo orgánico (Farm Boy)',     cat: 'otro', per100: 1.939, kc: 177, prot: 18, fat: 12, pack: '$19.39/kg',             per: '150g → $2.91 · 266 kcal' },
  'pollo-muslo-deshuesado': { name: 'Pollo · Contramuslo deshuesado (Foodland)',   cat: 'otro', per100: 2.379, kc: 180, prot: 19, fat: 12, pack: '$23.79/kg',             per: '120g → $2.85 · 216 kcal' },
  'pollo-pechuga':          { name: 'Pollo · Pechuga deshuesada (Beretta)',        cat: 'otro', per100: 2.563, kc: 120, prot: 22, fat: 2.6, pack: '$25.63/kg',            per: '120g → $3.08 · 144 kcal' },
