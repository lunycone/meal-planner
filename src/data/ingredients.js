...
export const ING = {
  // BASES
  patata:          { name: 'Patata',              cat: 'base',     per100: 0.093, kc: 77,  prot: 2,   fat: 0.1, fib: 2.2, gi: 80, pack: '50 lb · $21.19',         per: '200g → $0.19' },
  arroz:           { name: 'Arroz',               cat: 'base',     per100: 0.18,  kc: 360, prot: 7,   fat: 0.7, fib: 0.4, gi: 73, pack: '20 kg · $36.69',         per: '75g seco → $0.14' },
  ...
  'pan-masa-madre':{ name: 'Pan masa madre',      cat: 'base',     per100: 1.00,  kc: 265, prot: 9,  fib: 2.4, gi: 53, pack: '550 g · $5.50',           per: '60g → $0.60 · 159 kcal · 5.4g prot', est: true },
  avena:           { name: 'Avena (oats)',         cat: 'base',     per100: 0.429, kc: 389, prot: 17,  fat: 7,   fib: 10.6, gi: 55, pack: '1 kg · $4.29',           per: '50g → $0.21 · 195 kcal' },
  ...
  harina:          { name: 'Harina Ambrosia Unbleached All Purpose', cat: 'base', per100: 0.277, kc: 364, prot: 10, fat: 1.4, fib: 2.7, gi: 70, pack: '2270g · $6.29', per: '80g → $0.22' },
  'harina-garbanzo': { name: 'Harina de garbanzo (Ambrosia)', cat: 'base', per100: 0.428, kc: 387, prot: 22, fat: 7, fib: 11, gi: 35, pack: '908g · $3.89', per: '60g → $0.26 · 232 kcal · GI~35' },
  'masa-harina':   { name: 'Masa harina nixtamalizada (Maseca)', cat: 'base', per100: 0.500, kc: 363, prot: 10, fat: 4, fib: 7, gi: 52, pack: '2kg · $9.99', per: '55g → $0.28 · 200 kcal · GI~52' },
  ...
  'lentejas-verdes': { name: 'Lentejas verdes',   cat: 'legumbre', per100: 0.325, kc: 350, prot: 26,  fat: 1,   fib: 7.9, gi: 30, brand: "President's Choice Blue Menu",      store: 'No Frills',   pack: '2 kg · $6.50',    per: '80g seco → $0.26' },
  garbanzos:         { name: 'Garbanzos',         cat: 'legumbre', per100: 0.375, kc: 364, prot: 19,  fat: 6,   fib: 7.6, gi: 28, brand: 'Dunya Harvest Dried Chickpeas',    store: 'No Frills',   pack: '2 kg · $7.50',    per: '80g seco → $0.30' },
  'black-beans':     { name: 'Black beans',       cat: 'legumbre', per100: 0.300, kc: 340, prot: 22,  fat: 1.4, fib: 8.7, gi: 30, brand: 'Dunya Harvest Black Turtle Beans', store: 'FreshCo',     pack: '2 kg · $6.00',    per: '80g seco → $0.24' },
  ...
  'romano-beans':    { name: 'Judías romano (pintas)', cat: 'legumbre', per100: 0.399, kc: 335, prot: 21,  fat: 1.2, fib: 7.0, gi: 38, brand: 'Cedar Romano Beans',              store: 'Food Basics', pack: '1 kg · $3.99',    per: '80g seco → $0.32' },
  ...
  arandanos:         { name: 'Arándanos congelados (Farm Boy)', cat: 'fresco', per100: 0.977, kc: 57, prot: 0.7, fat: 0.3, fib: 2.4, gi: 53, pack: '2.25 kg · $21.99', per: '40g → $0.39 · 23 kcal' },
  banana:            { name: 'Banana',            cat: 'fresco',   per100: 0.25,  kc: 89,  prot: 1.1, fat: 0.3, fib: 2.6, gi: 51, pack: 'estimado ~$0.30/ud',    per: '120g → $0.30 · 107 kcal' },
  mandarina:         { name: 'Mandarina / Clementina', cat: 'fresco', per100: 0.660, kc: 53, prot: 0.9, fat: 0.2, fib: 1.7, pack: '907g · $5.99',          per: 'ud ~74g → $0.49 · 39 kcal' },
  naranja:           { name: 'Naranja',           cat: 'fresco',   per100: 0.440, kc: 47,  prot: 0.9, fat: 0.1, fib: 2.4, pack: '1.36kg · $5.99',        per: '½ ud ~100g → $0.44 · 47 kcal' },
  'melon-cantalupo': { name: 'Melón cantalupo',  cat: 'fresco',   per100: 0.233, kc: 34,  prot: 0.8, fat: 0.2, fib: 0.9, pack: '~1.5kg · $3.50 est.',   per: '200g → $0.47 · 68 kcal', est: true },
  ...
  chia:              { name: 'Semillas de chía',    cat: 'fresco', per100: 1.50,  kc: 486, prot: 17,  fat: 31, fib: 34, gi: 1, pack: 'estimado',              per: '12g → $0.18 · 58 kcal', est: true },
  ...
  manzana:          { name: 'Manzana',           cat: 'fresco', perUnit: 1.20, kcu: 95, protu: 0.5, fatu: 0.3, fibu: 4, gi: 36, pack: 'ud · $1.20', per: '1 ud → $1.20 · 95 kcal' },
